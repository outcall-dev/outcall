...
const CODEX_AUTH_ENV: &[&str] = &["CODEX_ACCESS_TOKEN", "CODEX_API_KEY", "OPENAI_API_KEY"];
...
const CLAUDE_DOCKERFILE: &str = include_str!("../../../recipe-images/claude/Dockerfile");

const CODEX_DOCKERFILE: &str = include_str!("../../../recipe-images/codex/Dockerfile");
...
- Environment auth: `CODEX_ACCESS_TOKEN`, `CODEX_API_KEY`, `OPENAI_API_KEY`
...
const CLAUDE_AGENT_CONFIG: &str = r#"# Generated by `outcall run claude`.
workspace: /workspace
...
const CODEX_AGENT_CONFIG: &str = r#"# Generated by `outcall run codex`.
workspace: /workspace
network: outcall-default
detach: false
auto_pull: true
...
const LEGACY_CLAUDE_AGENT_CONFIG: &str = r#"# Generated by `outcall recipe init claude`.
...
const LEGACY_CODEX_AGENT_CONFIG: &str = r#"# Generated by `outcall recipe init codex`.
...
pub(super) const HOST_RESOURCES_TEMPLATE: &str = r#"# Generated by `outcall run <recipe>`.
#
...
pub static RECIPES: &[Recipe] = &[
    Recipe {
        ...
        legacy_agent_configs: &[LEGACY_CLAUDE_AGENT_CONFIG],
    ...
    Recipe {
        ...
        legacy_agent_configs: &[LEGACY_CODEX_AGENT_CONFIG],
